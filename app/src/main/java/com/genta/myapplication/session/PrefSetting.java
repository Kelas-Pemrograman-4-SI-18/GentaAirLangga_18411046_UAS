package com.genta.myapplication.session;
...
import com.genta.myapplication.pembeli.homePembeli;
...
public class PrefSetting {
    ...
    public void isLogin(SessionManager session, SharedPreferences prefs) {
    }
}
