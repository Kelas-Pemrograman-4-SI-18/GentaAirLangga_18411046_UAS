...
import com.genta.myapplication.admin.ActivityDataKacamata;
import com.genta.myapplication.admin.EditKacamataDanHapusActivity;
import com.genta.myapplication.admin.homeAdmin;
...
public class homePembeli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterKacamata(homePembeli.this, newsList);
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(homePembeli.this, DetailKacamata.class);
